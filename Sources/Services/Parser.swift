struct Parser {
  ...
  private func peek(_ positionToPeekParam: Int? = nil) -> Token? {
    let positionToPeek = positionToPeekParam ?? position
    return position < tokens.count ? tokens[positionToPeek] : nil
  }
